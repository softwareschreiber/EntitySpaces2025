	...
	public class SQLiteForeignKeys : ForeignKeys
	{
		...
		private void _LoadAll(string query1, string query2)
		{
            ...
            try
            {
                ...
                DbDataAdapter adapter = SQLiteDatabases.CreateAdapter(query1, cn);
                adapter.Fill(metaData1);

                adapter = SQLiteDatabases.CreateAdapter(query2, cn);
                ...
                if (metaData1.Rows.Count > 0)
                {
                    ...
                    foreach (ForeignKey key in this)
                    {
                        ...
                        adapter = SQLiteDatabases.CreateAdapter(q, cn);
