...
namespace BusinessObjects
{
	...
	{	
		...
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.String TitleOfCourtesy
		{
			get { return base.TitleOfCourtesy;  }
			set { base.TitleOfCourtesy = value; }
		}

			
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.DateTime? BirthDate
		{
		...
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.String HomePhone
		{
		...
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.Byte[] Photo
		{
		...
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.Int32? ReportsTo
		{
			get { return base.ReportsTo;  }
			set { base.ReportsTo = value; }
		}

			
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.String PhotoPath
		{
			get { return base.PhotoPath;  }
			set { base.PhotoPath = value; }
		}
	...
	[DataContract]
	[Serializable]
	abstract public partial class esEmployees : EntityBase
	{
		public esEmployees()
		{
	...
	[Serializable]
	abstract public partial class esEmployeesCollection : CollectionBase<Employees>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esEmployeesQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
