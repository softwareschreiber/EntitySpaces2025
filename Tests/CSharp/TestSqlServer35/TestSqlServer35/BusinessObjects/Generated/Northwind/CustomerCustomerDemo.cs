...
namespace BusinessObjects
{
	...
	[DataContract]
	[Serializable]
	abstract public partial class esCustomerCustomerDemo : EntityBase
	{
		...
		{
			public esStrings(esCustomerCustomerDemo entity)
			{
				this.entity = entity;
			}
			...
			private esCustomerCustomerDemo entity;
		}
	...
	[Serializable]
	abstract public partial class esCustomerCustomerDemoCollection : CollectionBase<CustomerCustomerDemo>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esCustomerCustomerDemoQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
