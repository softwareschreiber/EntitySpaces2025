...
namespace BusinessObjects
{
	...
	{	
		...
		public override System.String CustomerTypeID
		{
			get { return base.CustomerTypeID;  }
			set { base.CustomerTypeID = value; }
		}

			
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.String CustomerDesc
		{
			get { return base.CustomerDesc;  }
			set { base.CustomerDesc = value; }
		}
	...
	[DataContract]
	[Serializable]
	abstract public partial class esCustomerDemographics : EntityBase
	{
	...
	[Serializable]
	abstract public partial class esCustomerDemographicsCollection : CollectionBase<CustomerDemographics>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esCustomerDemographicsQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
