...
namespace BusinessObjects
{
	...
	{	
		...
		public override System.String CategoryName
		{
		...
		[Column(IsPrimaryKey = false, CanBeNull = true)]
		public override System.Byte[] Picture
		{
	...
	[DataContract]
	[Serializable]
	abstract public partial class esCategories : EntityBase
	{
		public esCategories()
		{
	...
	[Serializable]
	abstract public partial class esCategoriesCollection : CollectionBase<Categories>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esCategoriesQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
