...
namespace BusinessObjects
{
	...
	{	
		...
		public override System.String RegionDescription
		{
			get { return base.RegionDescription;  }
			set { base.RegionDescription = value; }
		}
	...
	[DataContract]
	[Serializable]
	abstract public partial class esRegion : EntityBase
	{
		public esRegion()
		{
	...
	[Serializable]
	abstract public partial class esRegionCollection : CollectionBase<Region>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esRegionQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
