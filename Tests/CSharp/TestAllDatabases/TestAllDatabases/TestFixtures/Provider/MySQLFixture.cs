        ...
        public void MySQLUnicodeTest()
        {
                ...
                EntitySpaces.Interfaces.esSqlAccessType.DynamicSQL)
            {
                try
                {
                    ...
                    Assert.That(uniTest.VarCharType.Substring(6, 2), Is.EqualTo("��"));
                    Assert.That(uniTest.VarCharType.Length, Is.EqualTo(14));
                    Assert.That(uniTest.TextType.Substring(6, 2), Is.EqualTo("��"));
                    Assert.That(uniTest.TextType.Length, Is.EqualTo(14));
        ...
        public void MySQLBinaryTest()
        {
                ...
                EntitySpaces.Interfaces.esSqlAccessType.DynamicSQL)
            {
                try
                {
                    ...
                    Assert.That(datatypeTest.BinaryType.TrimEnd('\0'), Is.EqualTo("Hello"));
                    Assert.That(datatypeTest.VarBinaryType, Is.EqualTo("Hello 2"));
                    ...
                    Assert.That(datatypeTest.BinaryType.TrimEnd('\0'), Is.EqualTo("Testing"));
                    Assert.That(datatypeTest.VarBinaryType, Is.EqualTo("Testing 2"));
