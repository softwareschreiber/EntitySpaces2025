...
namespace BusinessObjects
{
	...
	{	
		...
		public override System.Int32? SupplierID
		{
		...
		public override System.String CompanyName
		{
		...
		public override System.String ContactName
		{
			get { return base.ContactName;  }
			set { base.ContactName = value; }
		}

			
		
		public override System.String ContactTitle
		{
			get { return base.ContactTitle;  }
			set { base.ContactTitle = value; }
		}

			
		
		public override System.String Address
		{
		...
		public override System.String City
		{
		...
		public override System.String PostalCode
		{
		...
		public override System.String Country
		{
		...
		public override System.String Phone
		{
		...
		public override System.String Fax
		{
			get { return base.Fax;  }
			set { base.Fax = value; }
		}
		...
		public override System.String HomePage
		{
			get { return base.HomePage;  }
	...
	[DataContract]
	[Serializable]
	abstract public partial class esSuppliers : EntityBase
	{
		public esSuppliers()
		{
			...
			if (col != null)
			{
				...
				{				
					...
					{							
						...
						case "ContactTitle": this.str().ContactTitle = (string)value; break;							
						...
						case "HomePage": this.str().HomePage = (string)value; break;
					}
				}
				else
				{
		...
		{
			public esStrings(esSuppliers entity)
			{
				this.entity = entity;
			}
			...
			public System.String ContactTitle
			{
				get
				{
					System.String data = entity.ContactTitle;
					return (data == null) ? String.Empty : Convert.ToString(data);
				}

				set
				{
					if (value == null || value.Length == 0) entity.ContactTitle = null;
					else entity.ContactTitle = Convert.ToString(value);
				}
			}
			...
			public System.String HomePage
			{
				get
				{
					System.String data = entity.HomePage;
					return (data == null) ? String.Empty : Convert.ToString(data);
				}

				set
				{
					if (value == null || value.Length == 0) entity.HomePage = null;
					else entity.HomePage = Convert.ToString(value);
				}
			}
			

			private esSuppliers entity;
		}
	...
	[Serializable]
	abstract public partial class esSuppliersCollection : CollectionBase<Suppliers>
	{
		#region Housekeeping methods
		override protected IMetadata Meta
		{
	...
	[Serializable]
	abstract public partial class esSuppliersQuery : QueryBase
	{
		override protected IMetadata Meta
		{
			get
